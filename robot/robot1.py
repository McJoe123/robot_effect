...
# Controls distortion (4)
H = 4

# Controls N samples in lookup table; probably leave this alone
LOOKUP_SAMPLES = 1024

# Frequency (in Hz) of modulating frequency (20)
MOD_F = 20
...
if __name__ == "__main__":
    ...
    """
    rate, data = wavfile.read('just_what_is_it.wav')
    data = data[:,1]
    ...
    wavfile.write('processed_just_what_is_it.wav', rate, result.astype(np.int16))